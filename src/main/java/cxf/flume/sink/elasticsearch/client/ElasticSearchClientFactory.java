 ...
 * under the License.
 */
package cxf.flume.sink.elasticsearch.client;

import cxf.flume.sink.elasticsearch.ElasticSearchEventSerializer;
import cxf.flume.sink.elasticsearch.ElasticSearchIndexRequestBuilderFactory;
...
public class ElasticSearchClientFactory {
  ...
  public ElasticSearchClient getClient(String clientType, String[] hostNames,
      ...
      ElasticSearchIndexRequestBuilderFactory indexBuilder) throws NoSuchClientTypeException,TransportClientTypeNotSupportException {
    if (clientType.equalsIgnoreCase(TransportClient)) {
       throw new TransportClientTypeNotSupportException();
  ...
  public ElasticSearchClient getLocalClient(String clientType,
      ...
      throws NoSuchClientTypeException,TransportClientTypeNotSupportException {
    if (clientType.equalsIgnoreCase(TransportClient) ) {
      throw new TransportClientTypeNotSupportException();
